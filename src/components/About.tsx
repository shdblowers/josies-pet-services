...
export default function About() {
  return (
    <div id="about" className="features9-thq-layout186-elm thq-section-padding">
      <div className="thq-section-max-width thq-flex-column">
        <h2 className="features9-thq-text-elm1 thq-heading-2">About me</h2>
        <p className="features9-thq-text-elm2 thq-body-large">
          Hi, I'm Josie, I provide pet sitting in the Chester area. I have been
        ...
        <p className="features9-thq-text-elm4 thq-body-large">
        ...
        <p className="features9-thq-text-elm5 thq-body-large">
          I am DBS checked and insured through Petplan Sanctuary, documents can
          be provided to view on request.&nbsp;
        </p>
        <img
